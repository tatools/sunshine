...
/**
 * The {@link Sun} class provides an implementation of a {@link Star} especially designed for
 * continuous integration servers. If any errors occur during tests execution, a continuous
 * integration server will fail the job's execution.
 *
